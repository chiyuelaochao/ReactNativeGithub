...
export default class CheckBoxFixed extends Component {
    ...
    genCheckedImage() {
        var source = this.state.isChecked ? require('../../res/images/ic_check_box.png')
    ...
    // Add this function to fix the bug of the CheckBox's state can't be changed when the CheckBox has been rendered
